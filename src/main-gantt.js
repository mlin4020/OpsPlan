...
const viewFromQuery = ['res', 'report', 'mod'].includes(params.get('view')) ? params.get('view') : 'report';
...
function boot() {
  ...
  const viewState = { view: viewFromQuery, zoom: 'day', collapsed: {}, dayW: 13, archOpen: false };
  // 工作日计算（注入本地兜底假期）
